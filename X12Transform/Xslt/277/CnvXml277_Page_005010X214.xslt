...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <div class="main">
          <div class="title">Health Care Claim Acknowledgment (277)</div>
  ...
  <xsl:include href="CnvXml277_Include_005010X214.xslt" />
  <xsl:include href="CnvXml277_Include_AMT.xslt" />
  <xsl:include href="CnvXml277_Include_DTP.xslt" />
  <xsl:include href="CnvXml277_Include_NM1.xslt" />
  <xsl:include href="CnvXml277_Include_QTY.xslt" />
  ...
  <xsl:include href="CnvXml277_Include_TRN_005010X214.xslt" />
