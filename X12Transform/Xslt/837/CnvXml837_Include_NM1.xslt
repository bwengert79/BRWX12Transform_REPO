...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="NM1">
    <tr>
      <td class="label">
        <xsl:choose>
          <xsl:when test="NM101 = '03'">Dependent:</xsl:when>
          <xsl:when test="NM101 = '1P'">Provider:</xsl:when>
          <xsl:when test="NM101 = '2B'">Third Party Administrator:</xsl:when>
          <xsl:when test="NM101 = '36'">Employer:</xsl:when>
          <xsl:when test="NM101 = '40'">Receiver:</xsl:when>
          <xsl:when test="NM101 = '41'">Information Receiver:</xsl:when>
