...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <div class="main">
          <div class="title">Health Care Claim: Professional (837)</div>
  ...
  <xsl:include href="CnvXml837_Include_005010X222.xslt" />
  ...
  <xsl:include href="CnvXml837_Include_CR1.xslt" />
  <xsl:include href="CnvXml837_Include_CR2.xslt" />
  <xsl:include href="CnvXml837_Include_CR3.xslt" />
  ...
  <xsl:include href="CnvXml837_Include_FRM.xslt" />
  ...
  <xsl:include href="CnvXml837_Include_LQ.xslt" />
  ...
  <xsl:include href="CnvXml837_Include_SV1.xslt" />
  <xsl:include href="CnvXml837_Include_SV5.xslt" />
